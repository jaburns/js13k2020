...
traceBox( ro, rd, dist, g_traceBits.y, i_BIT4, 0.,0.,0.,1.,18.5,8.2,126.32,23.,5.,23. );
traceBox( ro, rd, dist, g_traceBits.y, i_BIT5, 0.,0.707,0.,0.707,80.5,8.2,166.31,5.,5.,21. );
