...
static const float3 Xc0 = float3(0,8.7,24),Xc1 = float3(0,2.78,92.7),Xc2 = float3(-68.2,15.28,210.08),Xc3 = float3(-68.2,15.28,210.08);
...
{
traceBox( ro, rd, dist, g_traceBits.y, i_BIT0, 0.,0.,0.,1.,0.5,2.9,72.6,11.,1.5,11. );
traceBox( ro, rd, dist, g_traceBits.y, i_BIT1, 0.,0.,0.,1.,17.5,2.9,132.6,24.,7.,24. );
traceBox( ro, rd, dist, g_traceBits.y, i_BIT2, 0.,0.,0.,1.,0.5,2.9,92.6,6.,6.,21. );
traceBox( ro, rd, dist, g_traceBits.y, i_BIT3, 0.,0.707,0.,0.707,80.5,2.9,172.6,6.,6.,21. );
traceBox( ro, rd, dist, g_traceBits.y, i_BIT4, 0.,0.,0.,1.,0.5,2.9,92.6,1.5,1.5,1.5 );
traceBox( ro, rd, dist, g_traceBits.y, i_BIT5, 0.,0.,0.,1.,0.5,9.,-6.1,11.,1.5,15.545 );
traceBox( ro, rd, dist, g_traceBits.y, i_BIT6, 0.,0.,0.,1.,0.5,2.9,2.6,11.,3.,37.8 );
traceBox( ro, rd, dist, g_traceBits.y, i_BIT7, 0.,-0.707,0.,0.707,80.5,2.9,172.6,6.,5.,12.5 );
