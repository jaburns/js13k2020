...
#define Xc0 float3(0.44,0.13,64.8)
#define Xf0 float4(0,0,0,1)
#define Xc1 float3(0.44,0.13,60.8)
#define Xf1 float4(0,0,0,1)
#define Xc2 float3(0.44,0.13,56.8)
#define Xf2 float4(0,0,0,1)
#define Xc3 float3(0.44,0.13,53.7)
#define Xf3 float4(0,0,0,1)
