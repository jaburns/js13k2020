...
let resetState = () =>
{
    ...
    _stateFramebuffers.map(([fb, tex]) =>
    {
        ...
        // Initial state
            ...
            s_wheelBaseWidth, 10, 0, 0, // 28
            s_wheelBaseWidth, 10, z, 0, // 32
            0, 0, 0, 0, // 36
            0, 0, 0, 0, // 40

            s_wheelBaseWidth, 10, s_wheelBaseLength,   0, // 44
            s_wheelBaseWidth, 10, s_wheelBaseLength+z, 0, // 48
            0, 0, 0, 0, // 52
            0, 0, 0, 0, // 56

            0, 10, s_wheelBaseLength,   0, // 60
